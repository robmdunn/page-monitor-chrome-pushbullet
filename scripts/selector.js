...
function setUpBodyHandlers() {
  ...
  $('body').click(function (a) {
    if (pick_mode) return a = a.target,
    $(a).is('body') || $(a).closest('#' + FRAME_ID).length || (current_element = a, currentElementChanged(), pick_mode = !1, pick_button.removeClass(ACTIVE_CLASS)),
    !1
  })
}
